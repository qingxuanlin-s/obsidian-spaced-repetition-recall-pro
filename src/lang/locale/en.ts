...
export default {
    ...
    PATH_SPECIFIC_MAX_INTERVALS: "Path-specific maximum intervals",
    PATH_SPECIFIC_MAX_INTERVALS_DESC: "Set different maximum intervals for different folders/paths. Format: \"path:days\", one per line. Example: \"Folder1:30\" means cards in Folder1 and its subfolders have a maximum interval of 30 days. If not set, the default maximum interval above will be used.",
